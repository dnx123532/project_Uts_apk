              ...
              child: imagePath.startsWith('http')
                  ? Image.network(imagePath, fit: BoxFit.cover,
                      errorBuilder: (ctx, e, s) => Container(
                        ...
                        child: const Center(child: Icon(Icons.movie, color: Colors.white54, size: 60)),
                      ))
            ...
            child: Row(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: imagePath.startsWith('http')
                      ? Image.network(imagePath, width: 90, height: 120, fit: BoxFit.cover,
                          errorBuilder: (ctx, e, s) => Container(width: 90, height: 120,
                            color: Colors.grey.shade200, child: const Icon(Icons.movie, color: Colors.grey)))
