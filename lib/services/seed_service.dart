...
class SeedService {
  ...
  static final List<FoodItem> _foodItems = [
    const FoodItem(
      ...
      price: 85000,
      imagePath: 'assets/images/Combo_1.png',
    ...
    const FoodItem(
      ...
      price: 104000,
      imagePath: 'assets/images/online_exclusive combo _sweeet.png',
    ...
    const FoodItem(
      ...
      category: 'exclusive_combo',
      price: 99000,
      imagePath: 'assets/images/combo_savory.png',
    ...
    const FoodItem(
      ...
      category: 'exclusive_combo',
      price: 119000,
      imagePath: 'assets/images/online_exclusive_combo_2.png',
    ...
    const FoodItem(
      ...
      category: 'combo',
      price: 65000,
      imagePath: 'assets/images/Combo1_Popcorn_ Minuman.png',
    ),
    const FoodItem(
      id: 'cmb_002',
      ...
      category: 'combo',
      price: 79000,
      imagePath: 'assets/images/Combo_2_Popcorn_Besar_2_Minuman.png',
    ),
    const FoodItem(
      id: 'cmb_003',
      ...
      category: 'combo',
      price: 145000,
      imagePath: 'assets/images/Combo 3_Family_Pack.png',
    ),
    const FoodItem(
      id: 'snk_001',
      name: 'Popcorn Small',
      category: 'snack',
      price: 32000,
      imagePath: 'assets/images/Popcorn_Small.png',
    ),
    const FoodItem(
      id: 'snk_002',
      name: 'Popcorn Medium',
      category: 'snack',
      price: 42000,
      imagePath: 'assets/images/Popcorn_Medium.png',
    ),
    const FoodItem(
      id: 'snk_003',
      name: 'Popcorn Large',
    ...
    const FoodItem(
      ...
      category: 'snack',
      price: 38000,
      imagePath: 'assets/images/Nachos_+_Cheese.png',
    ),
    const FoodItem(
      id: 'snk_005',
      name: 'Hot Dog',
    ...
    const FoodItem(
      ...
      category: 'drink',
      price: 22000,
      imagePath: 'assets/images/Coca-Cola_Regular.png',
    ),
    const FoodItem(
      id: 'drk_002',
      ...
      category: 'drink',
      price: 28000,
      imagePath: 'assets/images/Coca-Cola_Large.png',
    ),
    const FoodItem(
      id: 'drk_003',
      name: 'Air Mineral',
      category: 'drink',
      price: 15000,
      imagePath: 'assets/images/Air_Mineral.png',
    ),
    const FoodItem(
      id: 'drk_004',
      name: 'Juice Jeruk',
      category: 'drink',
      price: 30000,
      imagePath: 'assets/images/Juice_Jeruk.png',
    ),
  ];
